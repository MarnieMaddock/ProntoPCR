  ...
  tagList(
      ...
      selectInput(ns("color_scheme_select"), 
                  ...
                  choices = c("Default" = "default", "Colourblind friendly 1" = "colourblind1",
                              ...
                              "Paul To - Bright" = "to_bright", "Paul To - Vibrant" = "to_vibrant", "Paul To - Muted" = "to_muted", "Paul To - Sunset" = "to_sunset",
                              "All Black" = "all_black", "All Gray" = "all_gray",
                              "Grays 1" = "grays", "Grays 2" = "grays2",
                              "Grays 3" = "grays3", "ElectraGray" = "electraGray", "Bones" = "bones",
                              "All Orange" = "all_orange",
                              "Oranges 1" = "oranges", "Oranges 2" = "oranges2", 
                              "All Pink" = "all_pink", "Pinks 1" = "pinks",
                              "Pinks 2" = "pinks2", 
                              "All Blue" = "all_blue", "All Blue 2" = "all_blue2", "Blues 1" = "blues", "Blues 2" = "blues2", 
                              "All Green" = "all_green", "All Green 2" = "all_green2", "Greens 1" = "greens",
                              "Greens 2" = "greens2", "Greens 3" = "greens3", "Green to Purple" = "green2purple",
                              "All Purple" = "all_purple", "Purples 1" = "purples", "Purples 2" = "purples3", "Purple to Orange" = "purple2orange",
      ...
      validate(
       ...
       #set seed for the graph
        ...
        color_schemes <- reactiveValues(colourblind1 = c("#00359c", "#648fff", "#785ef0", "#dc267f", "#fe6100", "#ffb000"),
                                                 ...
                                                 to_bright = c("#4477AA", "#66CCEE", "#228833", "#CCBB44","#EE6677", "#AA3377", "#BBBBBB"),
                                                 to_vibrant = c("#0077BB", "#33BBEE", "#009988", "#EE7733","#CC3311", "#EE3377", "#BBBBBB"),
                                                 to_muted = c("#332288", "#88CCEE", "#44AA99", "#117733","#999933", "#DDCC77", "#CC6677", "#882255", "#AA4499"),
                                                 to_sunset = c("#364B9A", "#4A7BB7", "#6EA6CD", "#98CAE1","#C2E4EF", "#EAECCC", "#FEDA8B", "#FDB366", "#F67E4B", "#DD3D2D", "#A50026"),
                                                 all_black = rep("#000000", 100), 
                                                 all_gray = rep("#6c757d", 100), 
