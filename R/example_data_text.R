example_data_text <- div(
  h4("Example CSV File"),
  tags$img(src = "table2.png", height = 400, width = 680),
  tags$br(),
  tags$br(),
  tags$br(),
  h4("Checklist:"),
div(
    ...
    tags$br(),
    tags$input(type = "checkbox", id = "option8"), tags$label("Persisting errors/no data loading? Contact Marnie: mlm715@uowmail.edu.au.", `for` = "option8"),
    )
)
